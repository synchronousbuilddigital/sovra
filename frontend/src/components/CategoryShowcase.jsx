...
const CategoryShowcase = () => {
    ...
    return (
        <section className="relative w-full py-16 md:py-32 px-6 md:px-24 bg-[#f5f0e8] overflow-hidden">
            <div className="max-w-[1720px] mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
                
                {/* Left: Featured Image Container */}
                <div className="relative w-full md:w-1/2 h-[450px] md:h-[800px] group">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="absolute inset-0 rounded-t-[100px] md:rounded-t-[200px] overflow-hidden shadow-2xl"
                        >
                            <img 
                                src={activeTab.image} 
                                alt={activeTab.name}
                    ...
                    <div className="absolute -top-4 -right-4 md:-top-6 md:-right-6 w-12 h-12 md:w-16 md:h-16 text-[#111110] z-20">
                    ...
                    <div className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 w-32 h-24 md:w-48 md:h-32 opacity-30 z-20 pointer-events-none">
                ...
                <div className="relative w-full md:w-1/2 flex flex-col justify-center mt-4 md:mt-0">
                    ...
                    <div className="space-y-8 md:space-y-12">
                        <div>
                            ...
                            <h2 className="font-editorial text-4xl sm:text-5xl md:text-7xl text-[#111110] leading-tight">Featured <br/><span className="italic font-light">Categories</span></h2>
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-4 md:gap-6">
                                        <span className={`font-editorial transition-all duration-500 ${
                                            activeTab.id === cat.id ? 'text-3xl sm:text-4xl md:text-5xl text-[#111110]' : 'text-lg sm:text-xl md:text-2xl text-[#7a7670] opacity-50'
                                        }`}>
                                            {cat.name}
                                        </span>
                                        {activeTab.id === cat.id && (
                                            <motion.div 
                                                layoutId="arrow"
                                                className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-[#111110] flex items-center justify-center"
                                            >
